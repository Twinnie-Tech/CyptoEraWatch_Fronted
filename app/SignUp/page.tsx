  ...
  <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1"
   ...
   height="auto" viewBox="0 0 744.84799 747.07702">
    <path id="fa3b9e12-7275-481e-bee9-64fd9595a50d" data-name="Path 1"
     ...
     transform="translate(-227.576 -76.46149)" fill="#f2f2f2"/>
     <path id="b3ac2088-de9b-4f7f-bc99-0ed9705c1a9d" data-name="Path 22" d="M747.327,253.4445h-4.092v-112.1a64.883,64.883,0,0,0-64.883-64.883H440.845a64.883,64.883,0,0,0-64.883,64.883v615a64.883,64.883,0,0,0,64.883,64.883H678.352a64.883,64.883,0,0,0,64.882-64.883v-423.105h4.092Z" 
  ...
  transform="translate(-227.576 -76.46149)" fill="#2f2e41"/></svg>
          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
            ...
            <div>
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  <button className="block w-full max-w-xs mx-auto bg-orange-500 hover:bg-orange-600 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">
                    REGISTER NOW
                  </button>
                </div>
              </div>
              <div className="text-center mt-4 text-gray-400 hover:underline hover:text-gray-700">
